...
using CostosWarehouse.ReporteEventosAtributos.Worker.Domain.Dtos;
using CostosWarehouse.ReporteEventosAtributos.Worker.Domain.Entities;
using MediatR;
...
namespace CostosWarehouse.ReporteEventosAtributos.Worker.Application.UseCase.V1.PersonOperation.Queries.GetList;
